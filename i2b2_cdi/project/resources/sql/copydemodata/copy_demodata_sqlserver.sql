...
from i2b2demodata.dbo.OBSERVATION_FACT 
ALTER TABLE OBSERVATION_FACT 
ADD CONSTRAINT OBSERVATION_FACT_PK PRIMARY KEY nonclustered (PATIENT_NUM, CONCEPT_CD,  MODIFIER_CD, START_DATE, ENCOUNTER_NUM, INSTANCE_NUM, PROVIDER_ID);
GO
...
BEGIN
    ALTER TABLE derived_concept_dependency
	DROP CONSTRAINT fk_derived_concept_id_dependency;
	ALTER TABLE derived_concept_dependency
	DROP CONSTRAINT fk_parent_concept_path;
END
...
from i2b2demodata.dbo.PATIENT_DIMENSION 
...
from i2b2demodata.dbo.PROVIDER_DIMENSION 
...
from i2b2demodata.dbo.MODIFIER_DIMENSION
...
from i2b2demodata.dbo.PATIENT_MAPPING
...
from i2b2demodata.dbo.ENCOUNTER_MAPPING
...
from i2b2demodata.dbo.VISIT_DIMENSION
...
from i2b2demodata.dbo.QT_BREAKDOWN_PATH


/*-------------i2b2------------- */
drop table i2b2
select  * into i2b2
from i2b2metadata.dbo.i2b2

/*-------------BIRN------------- */
drop table BIRN
select  * into BIRN
from i2b2metadata.dbo.BIRN

/*-------------CUSTOM_META------------- */
drop table CUSTOM_META
select  * into CUSTOM_META
from i2b2metadata.dbo.CUSTOM_META

/*-------------ICD10_ICD9------------- */
drop table ICD10_ICD9
select  * into ICD10_ICD9
from i2b2metadata.dbo.ICD10_ICD9

/*-------------TABLE_ACCESS------------- */
drop table TABLE_ACCESS
select  * into table_access
from i2b2metadata.dbo.table_access
