                ...
                with alive_bar(max_line, bar='smooth') as bar:
                    for row in csv_reader:
                        try:
                            ...
                            _row = [row['mrn'], row['vitalstatuscd'], row['birthdate'], row['deathdate'], row['sexcd'], row['ageinyears'], row['languagecd'], row['racecd'],
                                    row['maritalstatuscd'], row['religioncd'], row['zipcd'], row['statecityzippath'], row['incomecd'], '', '', '', self.import_time, Config.config.source_system_cd, str(Config.config.upload_id)]
